...
public interface DialogaActions {
    ...
    String DIALOGA_CONCORDO = "dialoga_concordo";
    String DIALOGA_DISCORDO = "dialoga_discordo";
    String DIALOGA_ENVIAR_RESPOSTA = "dialoga_enviar_resposta";
    String DIALOGA_ENVIAR_PERGUNTA = "dialoga_enviar_pergunta";
    String DIALOGA_GET_RESULTADO = "dialoga_get_resultado";
    String DIALOGA_GET_PERGUNTA_ALETORIA = "dialoga_get_pergunta_aleatoria";
