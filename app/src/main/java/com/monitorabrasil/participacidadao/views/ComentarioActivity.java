...
import com.monitorabrasil.participacidadao.actions.ComentarioActions;
import com.monitorabrasil.participacidadao.dispatcher.Dispatcher;
import com.monitorabrasil.participacidadao.stores.ComentarioStore;
import com.monitorabrasil.participacidadao.views.adapters.ComentarioAdapter;
...
public class ComentarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getStringExtra("projeto")!= null){
            ...
            idObjeto = getIntent().getStringExtra("politico");
